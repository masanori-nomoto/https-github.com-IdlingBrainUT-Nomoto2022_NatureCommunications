...
% use 1st (baseline), 2(CS), 4(ITI-1), 5th(ITI-2) columns
for i = [1 2 4 5]
result_CS_CA3_ctrl(:,i) = G1_results_resp0_removed_Z{i, 2}(1,:);
result_CS_CA3_ko(:,i)   = G2_results_resp0_removed_Z{i, 2}(1,:); 
end
