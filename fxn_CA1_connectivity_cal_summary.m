...
function [result]  = fxn_CA1_connectivity_cal_summary(input_data)
...
% Cell_type_C_ID  = G1_results{13,5}; % {13 is LTM-CS+ cell-IDs for refference, fixed as 5}
    ...
    %% 211109 added
    Cell_type_A_B_C_all_ID = unique([Cell_type_A_ID, Cell_type_B_ID, Cell_type_C_ID]);
    Cell_type_pure_C_ID = setdiff(Cell_type_A_B_C_all_ID, Cell_type_A_ID);
    Cell_type_pure_C_ID = setdiff(Cell_type_pure_C_ID, Cell_type_A_ID);
    
    Cell_type_A_B_all_ID = setdiff(Cell_type_A_B_C_all_ID, Cell_type_pure_C_ID);
...
% triple
[raster_connectivity_t_index_shared_triple, raster_connectivity_index_shared_triple, tirp_i1, trip_ii1] = ...
    fxn_sync_double_connectivity(data_input_temp, Cell_type_A_B_C_shared_ID, Cell_type_A_B_C_shared_ID, 1, ...
    Cell_type_A_ID, Cell_type_B_ID, Cell_type_C_ID); disp('Triple done!');

display('Shared and not-shared subpopulation double connectivity calculation done!')
%% added 211109
% all of A-CS and B-US vs. pure-LTM-CS C

% Not-shared between CS+US vs. LTMCS 
[raster_connectivity_t_index_AB_pureC, raster_connectivity_index_AB_pureC, i, ii] = ...
    fxn_sync_double_connectivity(data_input_temp, Cell_type_A_B_all_ID, Cell_type_pure_C_ID, 2, ...
    Cell_type_A_ID, Cell_type_B_ID, Cell_type_C_ID); disp('CS+US vs. LTM-CS shared done!');
...
% Ab vs. pure C, 211109 added
connectivity_results(10,i_index_cal) = raster_connectivity_index_AB_pureC;
...
connectivity_results_t{10,i_index_cal+1} = raster_connectivity_t_index_AB_pureC;
%%
...
%% ########### 500ms code ###############
% ca_binning_num_200ms = 4; % 20Hz to 1Hz data
ca_binning_num_500ms = 10; % 20Hz to 1Hz data
...
% Not-shared between CS+US vs. LTMCS 
[raster_connectivity_500ms_t_index_AB_pureC, raster_connectivity_500ms_index_AB_pureC, i, ii] = ...
    fxn_sync_double_connectivity(data_input_temp_500ms, Cell_type_A_B_all_ID, Cell_type_pure_C_ID, 2, ...
    Cell_type_A_ID, Cell_type_B_ID, Cell_type_C_ID); disp('CS+US vs. LTM-CS shared done!');
...
connectivity_results_500ms(10,i_index_cal) = raster_connectivity_500ms_index_AB_pureC;
...
connectivity_results_500ms_t{10,i_index_cal+1} = raster_connectivity_500ms_t_index_AB_pureC;
%%
loop_num = num2str(i_index_cal);
