function [results] = fxn_ca62400_12sessions_for_narrow_iti1(upsample_rate)
%% for debug,
...
% t_temp_s4 = [165 *upsample_rate+1 + 45*upsample_rate*(i-1): 165*upsample_rate + 45*upsample_rate*(i-1) + 15*upsample_rate]; % default
