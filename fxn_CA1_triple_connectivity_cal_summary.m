...
function [result]  = fxn_CA1_triple_connectivity_cal_summary(input_data)
...
connectivity_results_t{10,1} = ('Triple shared'); 
connectivity_results_t{11,1} = ('Triple non-shared');
...
%% Calculation of Double occurence in all cells
...
%% Calculation of Double occurence in shared and not-shared
% [raster_connectivity_t_index, raster_connectivity_index, i, ii] = ...
% fxn_sync_double_connectivity(data_input_temp, Cell_G1_ID, Cell_G2_ID, mymap_gradation_set, CS_ID, US_ID, LTMCS_ID)
% mymap_gradation_set, 0->Black, 1-> blue and green, 2-> red and green
...
% triple
% [raster_connectivity_t_index_shared_triple, raster_connectivity_index_shared_triple, dim_Ai, dim_Aii, dim_Aiii, shared_total_sync, shared_cell_500ms, shared_time_500ms] = ...
...
% 
% [raster_connectivity_t_index_not_shared_triple, raster_connectivity_index_not_shared_triple, dim_Ai, dim_Aii, dim_Aiii, non_shared_total_sync, non_shared_cell_500ms, non_shared_time_500ms] = ...
...
result.summary_500ms = connectivity_results_500ms;
% result.supple_500ms  = connectivity_supple_500ms;
% result.ITI1_500ms    = connectivity_results_500ms_t_block_ITI1;
% result.ITI2_500ms    = connectivity_results_500ms_t_block_ITI2;
%%
end
