function fxn_1s_bin_matrix(ca_1s_bin1, ca_1s_bin2, ca_1s_bin_mean1, ca_1s_bin_mean2, reshape_range)
...
% reshape_range = (16:600); % for Training
...
ax1 = subplot(511); imagesc(rs_mean1')   ; colormap(ax1,parula);  clim([0 0.2]);         
...
ax2 = subplot(512); imagesc(rs_mean2')   ; colormap(ax2,parula);  clim([0 0.2]);
c.Label.String = 'Mean z-score'; xlabel('Time (s)'); % ylabel('Trial#');
set(gca,'ytick',1:13); set(gca,'yticklabel',{'(Pre -135s)',' ','(Pre -45s)',' ','2',' ','4',' ', '6', ' ','8',' ','10',})
...
ax1 = subplot(514); imagesc(rs_mean1')   ; colormap(ax1,parula);  clim([0 0.2]);         
c = colorbar;  c.Label.String = 'Mean z-score'; xlabel('Time (s)'); % ylabel('Trial#'); 
set(gca,'ytick',1:13)
